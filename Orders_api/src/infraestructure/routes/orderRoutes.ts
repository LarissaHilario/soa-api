...
router.get('/orders', async (req, res) => await orderController.ordersList(req, res));
router.put('/orders/:id/status', async (req, res) => await orderController.updateOrder(req, res));
